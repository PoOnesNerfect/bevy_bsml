...
pub fn top_vw(percent: f32) -> StyleClass {
    StyleClass::Top(Top(Val::Vw(percent)))
}

pub fn top_vmin(percent: f32) -> StyleClass {
    StyleClass::Top(Top(Val::VMin(percent)))
}

pub fn top_vmax(percent: f32) -> StyleClass {
    StyleClass::Top(Top(Val::VMax(percent)))
}

pub fn top_div(n: u32, d: u32) -> StyleClass {
