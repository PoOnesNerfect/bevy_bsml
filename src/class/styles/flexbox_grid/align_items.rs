...
pub const ITEMS_START: StyleClass = StyleClass::AlignItems(AlignItems::FlexStart);
/// The items are packed towards the end of the axis, unless the flex direction is reversed;
/// then they are packed towards the start of the axis.
pub const ITEMS_END: StyleClass = StyleClass::AlignItems(AlignItems::FlexEnd);
